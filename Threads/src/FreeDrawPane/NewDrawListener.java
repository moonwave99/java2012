...
public class NewDrawListener implements MouseListener, MouseMotionListener
{

	protected NewDrawPane pane;

	public NewDrawListener(NewDrawPane pane)
	{
	...
	public void mousePressed(MouseEvent me)
	{
		...
		if(pane.getCurrentTratto() == null){
			...
			pane.setCurrentTratto(new Tratto(me.getPoint()));
